...
import com.bianca.support.preferences.PackageListAdapter;
import com.bianca.support.preferences.PackageListAdapter.PackageItem;
...
public class PackageListPreference extends PreferenceCategory implements
    ...
    public PackageListPreference(Context context, AttributeSet attrs) {
        ...
        boolean showSystemApps = customAttrs.getBoolean(R.styleable.PackageListPreferenceView_bianca_showSystemApps, true);
